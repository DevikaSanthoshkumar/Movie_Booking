...
//             // Pass the random generated booking_id to handlePayment function for order creation
//             handlePayment(localBookingId);
//         })
//         .catch((error) => {
...
//   const handlePayment = (localBookingId, backendBookingId) => {
//     axios
//       .post("http://127.0.0.1:8000/userAccount/generate_order/", {
//         amount: totalPrice,
//         order_id: localBookingId,
//       })
//       .then((response) => {
