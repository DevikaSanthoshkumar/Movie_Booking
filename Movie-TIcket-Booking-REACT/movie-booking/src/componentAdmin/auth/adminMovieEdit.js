...
//     const [time4, setTime4] = useState('00:00');
...
//                 // Assuming the show times are also returned in the movie data
//                 setTime1(movieData.time1);
//                 setTime2(movieData.time2);
//                 setTime3(movieData.time3);
//                 setTime4(movieData.time4);
//             })
//             .catch(error => {
...
//                                                 value={time1}
//                                                 checked={time1 !== "00:00"}
//                                                 onChange={(event) => setTime1(event.target.checked ? '11:30pm' : '00:00')} 
//                                             />
//                                             11:30pm
//                                         </label><br/>
//                                         <label for="t2">
...
//                                                 value={time2}
//                                                 checked={time2 !== "00:00"}
//                                                 onChange={(event) => setTime2(event.target.checked ? '2:30pm' : '00:00')} 
//                                             />
//                                             2:30pm
//                                         </label><br/>
//                                         <label for="t3">
...
//                                                 checked={time3 !== "00:00"}
//                                                 value={time3}
//                                                 onChange={(event) => setTime3(event.target.checked ? '5pm' : '00:00')} 
//                                             />
//                                             5pm
//                                         </label><br/>
//                                         <label for="t4">
...
//                                                 value={time4}
//                                                 checked={time4 !== "00:00"}
//                                                 onChange={(event) => setTime4(event.target.checked ? '9pm' : '00:00')} 
//                                             />
//                                             9pm
//                                         </label>
//                                 </div>
